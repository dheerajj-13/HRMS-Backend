...
const LeaveApplication = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            createNotification("25d31518-6330-4712-8874-a69641777263", `New Leave Request from ${currentUser.name}: ${reason}`, "info"); // Using the ID from create_users.ts if I had checked, but i'll guess or use a placeholder.
            // Wait, I should probably check the manager ID.
            // Actually, let's use a "global" notification for all managers? 
            // My helper supports "ALL". But that would notify everyone. 
            // Let's use a hardcoded mocked Manager ID "manager-1" and I'll update the Manager User to have this ID if needed, 
            // OR I can just default to notifying the user "manager@dotspeaks.com" if I knew the ID.
            ...
            createNotification("MANAGER", `New leave request from ${currentUser.name}`, "info");
